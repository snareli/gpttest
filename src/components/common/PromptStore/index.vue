...
import { NModal, NButton, NTabs, NTabPane,NTab } from 'naive-ui'
...
<template>
  <NModal v-model:show="show" style="width: 100%; max-width: 900px;" preset="card">
    <n-tabs default-value="oasis" justify-content="space-evenly" type="line">
      ...
      <n-tab-pane name="help" tab="初次使用">
        <div class="space-y-3">
          <p class="text-xl text-blue-800">此网站为个人测试使用，不保证稳定性！</p>
  ...
  <n-modal v-model:show="showModal" preset="card" style="width: 100%; max-width: 600px;" title="打赏作者">
    <template #header-extra>
      关闭
    </template>
    <div class="items-center">
      <h2 class="text-base">至今平原客，感激慕清风</h2>
      <div>
